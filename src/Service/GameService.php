...
class GameService
{
    ...
    private function getTranslationFromRow(array $imageRow, string $language): string
    {
        return match ($language) {
            'Français' => $imageRow['french_translation'] ?? $imageRow['word'],
            'Espagnol' => $imageRow['spanish_translation'] ?? $imageRow['word'],
            'Allemand' => $imageRow['german_translation'] ?? $imageRow['word'],

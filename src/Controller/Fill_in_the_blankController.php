...
class Fill_in_the_blankController extends AbstractController
{
    ...
    #[Route('/fill-in-the-blank/{childId}', name: 'fill_in_the_blank_play', methods: ['GET', 'POST'])]
    public function play(int $childId, Request $request): Response
    {
        ...
        if ($request->isMethod('POST')) {
            ...
            return $this->redirectToRoute('fill_in_the_blank_play', ['childId' => $childId]);
        }

 ...
 */
final class Version20250425074126 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE parents CHANGE parentId parentId INT NOT NULL, CHANGE verification_code verification_code VARCHAR(255) NOT NULL, CHANGE is_verified is_verified VARCHAR(255) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE parents CHANGE parentId parentId INT AUTO_INCREMENT NOT NULL, CHANGE verification_code verification_code VARCHAR(255) DEFAULT NULL, CHANGE is_verified is_verified VARCHAR(255) DEFAULT NULL');
